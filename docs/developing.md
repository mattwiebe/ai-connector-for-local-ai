...
- Release packaging on tags matching `v*`:
  ...
  - uploads the WordPress.org-generated ZIP to the GitHub release.
...
3. The workflow will deploy the tag to WordPress.org using the `SVN_USERNAME` and `SVN_PASSWORD` repository secrets.
4. The workflow will attach the WordPress.org-generated ZIP to the GitHub release automatically.
